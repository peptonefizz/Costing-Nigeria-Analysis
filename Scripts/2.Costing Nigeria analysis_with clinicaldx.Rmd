---
title: "Costing for CXR and AI in Nigeria. Includes clinically diagnosed patients"
author: "Tushar Garg"
date: "`r Sys.Date()`"
---
...
```{r session info}
sessioninfo::session_info(pkgs = c("loaded", "attached")[1], to_file = here("Session info","Costing_Nigeria_analysis_with clinicaldx_session_info.txt"))
```
...
export(list(summary_clinical = summary_clinical), here("Output","Clinical","visualization_clinical.xlsx"))
```
